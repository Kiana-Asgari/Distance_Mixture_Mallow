...
def generate_synthetic_mallow(n, alpha, beta, sigma, num_samples=10000, burn_in=1000, thin=10):
    permutation_samples = metropolis_hastings_sampler(beta, alpha, sigma, num_samples, burn_in, thin)
    return np.array(permutation_samples)
