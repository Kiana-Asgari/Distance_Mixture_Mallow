...
def read_model_comparisons_football(n_top_teams=10, 
                          output_dir='football/results/plots'):
    

    results_file=f'football/results/football_2019_n_top_teams={n_top_teams}(chronological).json'
    ...
    print('========Table of results for Mallow L1========')
