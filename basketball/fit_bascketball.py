...
def fit_basketball(training_ratio=0.8, Delta=7, seed=42, n_trials=50, n_teams_to_keep=10):
   ...
   # train_size = int(len(full_data) * training_ratio)
    ...
    for trial in range(n_trials):
        ...
        sampled_set = sample_truncated_mallow(n=n_teams_to_keep, alpha=alpha, beta=beta, sigma=sigma_0, Delta=Delta, num_samples=30_000)
        ...
        sampled_set = sample_PL(utilities=pl_utilities, n_samples=30_000)
        ...
        sampled_set = sample_kendal(sigma_0=sigma_0, theta=theta_hat, num_samples=30_000)
